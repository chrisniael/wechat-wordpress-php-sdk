...
class WechatWordpress
{
    ...
    public function responseMsg()
    {
        ...
        {            
            ...
            $menuText = '主页:<a href = "' . SITE . '">程序员修炼之道</a>' . "\n\n".
                        '[1]近期文章    <a href="' . SITE . '/?page_id=6">书籍推荐</a>' . "\n\n".
                        '[2]文章归档    <a href="' . SITE . '/?page_id=11">网站链接</a>' . "\n\n".
                        '[3]分类目录    <a href="' . SITE . '/?page_id=9">留言小本</a>' . "\n\n".
                        '[4]标签列表    <a href="' . SITE . '/?page_id=5">关于本站</a>' . "\n\n".
                        "回复 [ ] 内的 数字\n\n";
